 ...
 */
public class ViewDragHelperEnhance {
     ...
     */
    public static ViewDragHelperEnhance create(@NonNull ViewGroup forParent, @NonNull Callback cb) {
        return new ViewDragHelperEnhance(forParent.getContext(), forParent, cb);
    }
     ...
     * @return a new ViewDragHelper instance
     */
    public static ViewDragHelperEnhance create(@NonNull ViewGroup forParent, float sensitivity,
                                               @NonNull Callback cb) {
        final ViewDragHelperEnhance helper = create(forParent, cb);
     ...
     * @param forParent Parent view to monitor
     */
    private ViewDragHelperEnhance(@NonNull Context context, @NonNull ViewGroup forParent,
                                  @NonNull Callback cb) {
        if (forParent == null) {
